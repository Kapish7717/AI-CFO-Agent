...
async def call_model(state: AgentState):
    ...
    system_prompt = SystemMessage(content=(
        ...
        "DATA QUERYING & QUESTION ANSWERING:\n"
        "- If the user asks a specific question about transactions, balances, spending, categories, merchants, anomalies, or dates (e.g. 'how much did we pay Skyline last month?' or 'what was our highest expense?'), you must call the 'query_financial_data' tool with appropriate filters (search_query, category, entity, transaction_type, start_date, end_date, user_id).\n"
        "- Use the results from 'query_financial_data' to formulate a clear, precise, and data-driven response to the user.\n\n"
        "RULES:\n"

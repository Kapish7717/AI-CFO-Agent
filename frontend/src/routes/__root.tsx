    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          The workflow node failed. Try again or return home.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AI CFO — Autonomous Financial Intelligence" },
      { name: "description", content: "An AI-native Financial Operating System with BYOK LLM support, multi-agent LangGraph workflows, and enterprise data connectors." },
      { property: "og:title", content: "AI CFO — Autonomous Financial Intelligence" },
      { property: "og:description", content: "An AI-native Financial Operating System with BYOK LLM support and multi-agent workflows." },
